...
NATIVE_FUNCTION_HEAD(void, glFinish) MG_FRAME_STATS_SELECTED_GL_SCOPE() NATIVE_FUNCTION_END_NO_RETURN(void, glFinish)
...
// NATIVE_FUNCTION_HEAD(void, glGetBufferParameteri64v, GLenum target, GLenum pname, GLint64 *params) NATIVE_FUNCTION_END_NO_RETURN(void, glGetBufferParameteri64v, target,pname,params)   // moved to gl/buffer.cpp so backend-strengthened storage still reports the caller's requested flags
